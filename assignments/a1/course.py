...
class Student:
    ...
    === Private Attributes ===
    questions_and_answers: stores questions and answers the student has
    ...
    def has_answer(self, question: Question) -> bool:
        ...
        """
        if question.id in self.questions_and_answers and question.validate_answer(self.questions_and_answers[question.id]):
            return True
        return False
    ...
    def set_answer(self, question: Question, answer: Answer) -> None:
        ...
        """
        self.questions_and_answers[question.id]= answer
    ...
    def get_answer(self, question: Question) -> Optional[Answer]:
        ...
        """
        if question.id in self.questions_and_answers:
            return self.questions_and_answers[question.id]
        return None
...
class Course:
    ...
    def enroll_students(self, students: list[Student]) -> None:
        ...
        """
        new_list = sort_students(students, 'id')
        add_students = True
    ...
    def get_students(self) -> tuple[Student]:
        ...
        """
        all_students_sorted = sort_students(self.students, 'id')
        return tuple(all_students_sorted)
